...
import { ActivityCardInterface } from "../../types";


const ActivityCard = ({className, icon, iconBackground, name, path}: ActivityCardInterface) => {
  return (
    <Link href={path} className="flex-grow inline-block">
